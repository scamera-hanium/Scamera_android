package com.example.davichiar.scamera_android.QRSearch;
...
public class QRCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(QRCodeActivity.this, QRCodeActivity.class);
        ...
        completeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clipBoardText == null) {
                    ...
                    Intent intent1 = new Intent(QRCodeActivity.this, MainActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (DATARESULT == requestCode)
        {
            if (data != null)
            {
                ...
                if(checkResult == 0) {
                    Toast.makeText(getApplicationContext(), "잘못된 형식의 QR 코드 입니다.", Toast.LENGTH_SHORT).show();
                    Intent intent1 = new Intent(QRCodeActivity.this, QRCodeActivity.class);
                    startActivity(intent1);
                }
                else {
                    ...
                    mWebView.loadUrl(barcodeResult); // 웹뷰에 표시할 웹사이트 주소, 웹뷰 시작
                }
            }
            else
            {
    ...
    private void dataOperations(String stringvalue,Barcode barcode) {
        if (Patterns.WEB_URL.matcher(stringvalue).matches()) checkResult = 1;
        else checkResult = 0;
    }
